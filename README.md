...
[Live Demo Link](https://recipe-app-addisu-david.herokuapp.com)
...
### Setup
    ...
    git clone https://github.com/indigodavid/recipe_app.git
    cd recipe_app/
### Install
...
- [Heroku](https://recipe-app-addisu-david.herokuapp.com)
## Authors
